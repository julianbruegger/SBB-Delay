...
url = "https://data.sbb.ch/api/records/1.0/search/?dataset=ist-daten-sbb&q=&rows=22&facet=betreiber_id&facet=produkt_id&facet=linien_id&facet=linien_text&facet=verkehrsmittel_text&facet=faellt_aus_tf&facet=bpuic&facet=ankunftszeit&facet=an_prognose&facet=an_prognose_status&facet=ab_prognose_status&facet=ankunftsverspatung&facet=abfahrtsverspatung&refine.bpuic=8508218"
...
for i in range (nhits):
    ...
    sql = "INSERT INTO delay_Mal (abfahrtszeit, ab_prognose, abfahrtsverspatung, ankunftszeit, betriebstag,verkehrsmittel_text, faellt_aus_tf, linien_text, an_prognose) VALUES (%s,%s,%s,%s,%s,%s,%s,%s,%s)"
