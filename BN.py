...
for i in range (nhits):
    ...
    sql = "INSERT INTO delay_BN (abfahrtszeit, ab_prognose, abfahrtsverspatung, ankunftszeit, betriebstag,verkehrsmittel_text, faellt_aus_tf, linien_text, an_prognose) VALUES (%s,%s,%s,%s,%s,%s,%s,%s,%s)"
